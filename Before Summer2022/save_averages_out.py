...
experiments = { # A dictionary of all the experiments and the order in which
    ...
    "One_Way_Sweep":["HH","five_H","ten_H","fifteen_H","twenty_H",
                     "twentyfive_H","thirty_H","thirtyfive_H",
                     "forty_H","fortyfive_H","fifty_H","fiftyfive_H",
                     "sixty_H","sixtyfive_H","seventy_H"]       #failed investigation 6/26/2019
...
def save(outputdict, savefilepath, experimentName, headers = ["State", "Coincident Counts Average", "Coincident Counts Uncertainty"]):
    ...
    with open(savefilepath, "w+", newline = "\n") as csvfile:
        ...
        loopcount = 0
        probBool = False
        singleBasis = ['Circular', 'HV_Basis', 'Purity','Diagonal_Smileyface','Antidiagonal_Sailboat']
