...
experimentStates = { "Full_Tomography": # This is a list of the states in the
    ...
    "Witness": ["HH", "HV", "VH", "VV",  
                "DD", "DA", "AD", "AA",   
                "RR", "RL", "LR", "LL"],
    "W1 prime to W3 prime": ["HH", "HV", "VH", "VV",  
                            "DD", "DA", "AD", "AA",   
                            "RR", "RL", "LR", "LL",
                            "DR", "DL", "AR", "AL",
                            "RD", "RA", "LD", "LA"], 
    "W4 prime to W6 prime": ["HH", "HV", "VH", "VV",  
                            "DD", "DA", "AD", "AA",   
                            "RR", "RL", "LR", "LL",
                            "RH", "RV", "LH", "LV",
                            "HR", "HL", "VR", "VL"],
    "W7 prime to W9 prime": ["HH", "HV", "VH", "VV",  
                            "DD", "DA", "AD", "AA",   
                            "RR", "RL", "LR", "LL",
                            "DH", "DV", "AH", "AV",
                            "HD", "HA", "VD", "VA"],
...
def main(**kwargs):
    ...
    Motors.move_to("OO") # Reset motors to "0" position when done
