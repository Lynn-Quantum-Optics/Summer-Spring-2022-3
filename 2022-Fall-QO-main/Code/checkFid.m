function [maxFid, I] = checkFid(rho)
...
% lab computer: load('/home/qiyang/Downloads/theory/Data/undetectedW_6566.mat')
...
for m = 0:2
    ...
    elseif (contains(char(nf),'a1') || contains(char(nf),'a2')) && contains(char(nf),'b') && contains(char(nf),'t')
        x0 = [0,0,0];
...
% figure
% plot(maxFid(:,2),maxFid(:,1),'.')
% hold on
% xlabel("\lambda_{max}")
% ylabel("maximum fidelity")