...
def get_model(n_inputs, n_outputs):
    model = Sequential()
    model.add(Dense(210, input_dim=n_inputs, kernel_initializer='he_uniform', activation='relu'))
...
data_1 = 'all_w_10000.csv'
data_2 = 'all_states.csv'
data_3 = 'all_states_2.csv'
...
with open("model_60000.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model_60000.h5")
